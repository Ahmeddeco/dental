...
function PricingSection() {
	return (
		<section className=" relative h-auto py-12  overflow-hidden bg-gradient-to-b from-background via-muted/3 to-background">
			...
			<div className="relative  container mx-auto z-10 max-w-7xl px-6 ">
				{/* Header */}
